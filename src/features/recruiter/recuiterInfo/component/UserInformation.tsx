...
export default function UserInformation({ loading,password,reload }) {
  ...
  }, [loading, isRecall, setValue, password,reload]);
            ...
            >
              {recruiterProfile.status == "ACTIVE" && (
                <Flex direction={"row"} align={"center"} justify={"space-between"} w={"100%"}>
                 ...
                 {recruiterProfile.vip &&
                  <Group>
                  <Image src={"/src/assets/img/company_vip.png"}  w={"30px"}/>
                  <Text c={"purple"} size="14px" fw={700}>
                    Tài khoản VIP
                  </Text>
                </Group>
                 }
