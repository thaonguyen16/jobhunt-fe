...
import { getCountUser, getUsersData } from "@/api/user";
        ...
        <Flex align="center" gap="md" mb="lg">
          ...
          >
            <Flex justify="space-between" align="center" direction="column">
              ...
              <Text size="xl" fw={500} style={{ color: "#0572cc" }}>
                {countUserQuery.data?.data.totalAccount}
              </Text>
            </Flex>
          </Card>
          {/* Card Doanh nghiệp */}
          ...
          >
            <Flex justify="space-between" align="center" direction="column">
              ...
              <Text size="xl" fw={500} style={{ color: "#2b8a3e" }}>
                {countUserQuery.data?.data.employerNo}
              </Text>
            </Flex>
          </Card>
          ...
          >
            <Flex justify="space-between" align="center" direction="column">
              ...
              <Text size="xl" fw={500} style={{ color: "#d6336c" }}>
                {countUserQuery.data?.data.candidateNo}
              </Text>
            </Flex>
          </Card>
          ...
          >
            <Flex justify="space-between" align="center" direction="column">
              ...
              <Text size="xl" fw={500} style={{ color: "#d6336c" }}>
                {countUserQuery.data?.data.adminNo}
              </Text>
            </Flex>
          </Card>
        </Flex>
