  ...
  const sidebar = (
    <Box>
      ...
      <NavLink
        ...
        leftSection={
          <svg
            id="Folder-Settings--Streamline-Atlas"
          ...
          >
            <desc>
              {"Folder Settings Streamline Icon: https://streamlinehq.com"}
            </desc>
            <defs />
            <path
              d="M9.375 2.6640625 7.8828125 1.171875H1.171875v14.9140625a1.484375 1.484375 0 0 0 1.4921875 1.4921875h13.421875a1.484375 1.484375 0 0 0 1.4921875 -1.4921875V2.6640625Z"
              fill="none"
              stroke="#000000"
              strokeMiterlimit={10}
              strokeWidth={1}
            />
            <path
              d="M7.140625 11.609375a2.234375 2.234375 0 1 0 4.46875 0 2.234375 2.234375 0 1 0 -4.46875 0"
              fill="none"
              stroke="#000000"
              strokeMiterlimit={10}
              strokeWidth={1}
            ...
            />
            <path
              d="m7.4375 10.4921875 -1.2890625 -0.7421875"
              fill="none"
              stroke="#000000"
              strokeMiterlimit={10}
              strokeWidth={1}
            />
            <path
              d="m12.6015625 13.4765625 -1.2890625 -0.7421875"
              fill="none"
              stroke="#000000"
              strokeMiterlimit={10}
              strokeWidth={1}
            ...
            />
            <path
              d="m11.3125 10.4921875 1.2890625 -0.7421875"
              fill="none"
              stroke="#000000"
              strokeMiterlimit={10}
              strokeWidth={1}
            />
            <path
              d="m6.1484375 13.4765625 1.2890625 -0.7421875"
              fill="none"
              stroke="#000000"
              strokeMiterlimit={10}
              strokeWidth={1}
            ...
            />
            <path
              d="m1.171875 5.6484375 16.40625 0"
              fill="none"
              stroke="#000000"
              strokeMiterlimit={10}
              strokeWidth={1}
        ...
        <NavLink
          ...
          leftSection={
            <svg
              ...
              id="Content-Paper-Edit--Streamline-Ultimate"
              pathLength={20}
              width={20}
            >
              <desc>
...
<NavLink
        ...
        leftSection={<IconPackages stroke={1} />}
        childrenOffset={28}
        defaultOpened
      >
        <NavLink
...
<NavLink
        ...
        active={selectedTab === "lich-su-don-hang"}
        onClick={() => setSelectedTab("lich-su-don-hang")}
        label={<IconHistoryToggle stroke={1} />}
      />
  ...
  const main = (
    <>
      ...
      {selectedTab === "goi-vip" && <PlanSection type={"CANDIDATE_PLAN"} />}
